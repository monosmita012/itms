        ...
        <CardContent>
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="ai-analysis" className="space-y-4">
              {/* AI Analysis Video with Enhanced Overlays */}
              <div className="relative bg-black rounded-lg overflow-hidden" style={{ aspectRatio: '16/9' }}>
                <img 
                  src="https://images.unsplash.com/photo-1474487548417-781cb71495f3?w=800&h=450&fit=crop"
                ...
                <div className="absolute inset-0">
                  {/* Primary defect with confidence score */}
                ...
                {/* AI Processing Stats */}
                <div className="absolute top-4 left-4 bg-black/70 text-white px-2 py-1 rounded text-sm">
                  AI ANALYSIS | 28ms processing | 34.7 FPS
                </div>
                
                {/* Model info */}
                <div className="absolute bottom-4 right-4 bg-black/70 text-white px-2 py-1 rounded text-sm">
                  YOLOv8-Rail | NVIDIA Jetson
                </div>
              </div>
            </TabsContent>
          </Tabs>
