      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="detections" className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card className="backdrop-blur bg-white/60 border-2 border-red-200">
              <CardHeader>
            ...
            {/* Detection Details */}
            <Card className="backdrop-blur bg-white/60 border-2 border-blue-200">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                        ...
                        <>
                          ...
                          {compareMode === 'side-by-side' ? (
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                              <div>
                                <div className="mb-2 text-sm text-gray-700">Raw Frame</div>
                                <div className="relative aspect-video bg-gray-800 rounded-lg overflow-hidden">
                                  <div className="absolute inset-0 bg-gradient-to-br from-gray-700 to-gray-900"></div>
                                  <div className="absolute top-2 left-2 text-white text-xs font-mono bg-black/50 px-2 py-1 rounded">RAW</div>
                                </div>
                              </div>
                              <div>
                                <div className="mb-2 text-sm text-gray-700">AI Processed</div>
        ...
        <TabsContent value="models" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {aiModels.map((model, index) => (
              <Card key={index} className="backdrop-blur bg-white/60 border-2 border-purple-200">
